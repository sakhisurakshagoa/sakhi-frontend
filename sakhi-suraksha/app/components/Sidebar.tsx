    ...
    <>
      ...
      >
        ...
        <nav className="overflow-y-auto p-6 flex flex-col gap-2 text-sm font-medium text-gray-600">
          ...
          <Link href="/essential-locations" className={`flex items-center gap-3 px-3 py-2 rounded-lg
            ${pathname === "/essential-locations" ? "bg-gradient-to-r from-purple-500 to-teal-400 text-white font-semibold" : "hover:text-purple-700"}`}>
            <MapPinIcon className={`w-5 h-5 ${pathname === "/essential-locations" ? "text-white" : "text-purple-700"}`} />
            Essential Locations
          </Link>
